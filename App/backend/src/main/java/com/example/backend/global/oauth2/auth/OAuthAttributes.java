package com.example.backend.global.oauth2.auth;

import com.example.backend.domain.user.Enum.Role;
import com.example.backend.domain.user.Enum.SocialType;
import com.example.backend.domain.user.entity.User;
import com.example.backend.global.oauth2.userinfo.GoogleOAuth2UserInfo;
import com.example.backend.global.oauth2.userinfo.NaverOAuth2UserInfo;
import com.example.backend.global.oauth2.userinfo.OAuth2UserInfo;
