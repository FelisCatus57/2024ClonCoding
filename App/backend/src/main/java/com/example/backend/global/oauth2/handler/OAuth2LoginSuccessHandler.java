package com.example.backend.global.oauth2.handler;
...
import com.example.backend.global.oauth2.auth.CustomOAuth2User;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        try {
            ...
            if(oAuth2User.getRole() == Role.GUEST) {
                ...
                String accessToken = jwtService.createAccessToken(oAuth2User.getUsername(), findUser.getNickname());
